...
echo "Suwayomi Exp data location: /home/suwayomi/.local/share/Tachidesk"

# Seed / refresh baked-in ExpUI into the data volume
...
if [ -f /opt/catch_abort.so ]; then
  export LD_PRELOAD="/opt/catch_abort.so${LD_PRELOAD:+ $LD_PRELOAD}"
